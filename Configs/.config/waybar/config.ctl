...
1||top|( wlr/workspaces hyprland/window ) ( mpris )|( clock )|( cpu memory ) ( battery ) ( network bluetooth pulseaudio pulseaudio#microphone custom/updates ) ( tray ) ( custom/mode custom/cliphist custom/power )
